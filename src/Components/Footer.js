            ...
            <footer className="footer ">
                <div className="container">
                    <div className="footer-logo">
                        <div className="img-wrap"><a href="/"><img
                    ...
                    <ul className="footer-menu">
                        ...
                        <li><a href="/">Become an Aladyyn Seller</a></li>
                        <li><a href="/advertiser-enquiry">Advertise at Aladyyn</a></li>
                    ...
                    <div className="social-links">
                        ...
                        <ul>
                            ...
                            <li><a href="/"><i className="icon-insta"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div className="copyright-block ">
                    <div className="container"><span className="copyright-info">Copyright © 2021 Aladyyn. All Rights Reserved</span></div>
                </div>
            </footer>
        </>
    )
